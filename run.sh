# Pthreads--------------
# g++ main_pthread.c lab1_pthread.cpp lab1_io.c -std=c++11 -pthread -fopenmp
# ./a.out 10 2 ./dataset/dataset_100000_10.txt out1.txt out2.txt
...
# ./a.out 10 ./dataset/dataset_100000_10.txt out1.txt out2.txt
